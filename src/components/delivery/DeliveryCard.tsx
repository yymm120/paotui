  ...
  return (
    ...
    >
      ...
      <CardHeader className="flex h-auto flex-row items-center justify-between px-3 py-2 sm:h-9 sm:py-1">
        <div className="flex-1 text-left text-sm font-normal text-black sm:h-[26px] sm:w-[186px] sm:text-center sm:text-base">
          {order.deliveryTime}
        </div>
      ...
      <CardContent className="flex w-full items-center justify-center px-3 py-0">
        <div className="flex flex-1 flex-col items-start gap-3">
          ...
          <div className="flex w-full items-start gap-2.5">
            <DistanceIndicator
              fromDistance={order.fromDistance}
              toDistance={order.toDistance}
            />
      ...
      {/* Footer */}
      <CardFooter className="flex h-auto w-full flex-col items-center justify-center gap-2.5 bg-white px-3 py-3 sm:h-12 sm:py-2.5">
        <Button
