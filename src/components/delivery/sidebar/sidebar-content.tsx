...
export function SidebarContent() {
  const { incomeToday, orderCountTody } = useWorkInfoToday();
  const [displayInfo, setDisplayInfo] = useState<boolean>(false);
  const [userName] = useState<string>("罗*昊");
    ...
    <div className="self-stretch px-3 bg-white inline-flex flex-col justify-start items-center gap-3 overflow-hidden">
      ...
      <div className="self-stretch px-4 py-3 bg-rose-100 rounded-xl shadow-[0px_0px_1px_0px_rgba(0,0,0,0.40)] inline-flex justify-start items-center gap-12 overflow-hidden">
        <div className="w-32 inline-flex flex-col justify-center items-start gap-3">
          ...
          <Button
            variant={"link"}
            className="cursor-pointer pl-0 self-stretch inline-flex justify-start items-center gap-1 overflow-hidden"
          >
        ...
        <div className="w-32 inline-flex flex-col justify-center items-start gap-3 overflow-hidden">
          ...
          <Button
            variant={"link"}
            className="cursor-pointer pl-0 self-stretch inline-flex justify-start items-center gap-1"
          >
            <div className="w-14 justify-center text-rose-950 text-sm font-medium font-['Inter']">
              订单统计
            </div>
