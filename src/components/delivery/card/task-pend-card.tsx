...
export function TaskPendCard({ task, className }: DeliveryCardProps) {
    ...
    >
      ...
      <CardFooter className="flex rounded-2xl h-16 w-full flex-col items-center justify-center gap-2.5 bg-white px-3 py-1">
        <Button
          ...
          className="cursor-pointer h-12 w-full flex-shrink-0 rounded-lg bg-blue-400 text-base font-bold text-white"
        >
          {"取货"}
        </Button>
      </CardFooter>
