...
// #[cfg(test)]
// mod tests {
//   use crate::model::app_state::{AppIdentify, AppState};
...
//       db,
//       sender: broadcast::channel::<String>(16).0,
//       app_identify: AppIdentify::DeliveryApp,
//       private_sockets: Default::default(),
//       official_broadcast: Default::default(),
//     };
//
...
//     .await?;
//
//     let claims = generate_claims(UserType::VerifiedUser, Some(ClaimsUser::from(user)));
